...
public class TimetableController(ITimetableService service) : BaseController
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateTimetableAsync([FromBody] CreateTimetableRequest request)
    {
    ...
    [HttpGet]
    public async Task<ActionResult<TimetableSummaryResponse>> GetTimetablesAsync()
    {
